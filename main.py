...
def my_script():
    ...
    try:
        ...
        wlist_number = driver.find_elements(By.XPATH,"//td[.//font[text()='WLIST'] or .//font[text()='WL FULL']]/preceding-sibling::td[1]")
        new_value = 9999
        for el in wlist_number:
            print("Number in the wait list is :", el.text.strip())
